...
using Map_uint64_t_2_uint64_t = std::map<uint64_t, uint64_t>;
...
using Map_string_2_pair_uint64_t_int = std::map<std::string, std::pair<uint64_t, int>>;
using Map_string_2_pair_map_uint64_t_2_uint64_t_int = std::map<std::string, std::pair<std::map<uint64_t, uint64_t>, int>>;
...
PYBIND11_MAKE_OPAQUE(Map_uint64_t_2_uint64_t);
...
PYBIND11_MAKE_OPAQUE(Map_string_2_pair_uint64_t_int);
PYBIND11_MAKE_OPAQUE(Map_string_2_pair_map_uint64_t_2_uint64_t_int);
...
PYBIND11_MODULE(rbdx, m) {
  ...
  {
    auto b = py::bind_map<Map_uint64_t_2_uint64_t>(m, "Map_uint64_t_2_uint64_t");
    b.def("__repr__", [](const Map_uint64_t_2_uint64_t& self) {
      return json_fmt(self).dump(json_indent);
    });
  }
  {
  ...
  {
    auto b = py::bind_map<Map_string_2_pair_uint64_t_int>(m, "Map_string_2_pair_uint64_t_int");
    b.def("__repr__", [](const Map_string_2_pair_uint64_t_int& self) {
      return json_fmt(self).dump(json_indent);
    });
  }
  {
    auto b = py::bind_map<Map_string_2_pair_map_uint64_t_2_uint64_t_int>(m, "Map_string_2_pair_map_uint64_t_2_uint64_t_int");
    b.def("__repr__", [](const Map_string_2_pair_map_uint64_t_2_uint64_t_int& self) {
      return json_fmt(self).dump(json_indent);
    });
  }
  {
  ...
  //
  {
    ...
    using list_du_func_t_1 = int (xRBD::*)(librados::IoCtx&,
        std::map<std::string, std::pair<uint64_t, int>>*);
    using list_du_func_t_2 = int (xRBD::*)(librados::IoCtx&,
        const std::map<std::string, std::string>&,
        std::map<std::string, std::pair<uint64_t, int>>*);
    using list_du_v2_func_t_1 = int (xRBD::*)(librados::IoCtx&,
        std::map<std::string, std::pair<std::map<uint64_t, uint64_t>, int>>*);
