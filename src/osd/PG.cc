                  ...
                  RecoveryCtx *ctx)
{
  ...
  if (is_primary()) {
    ...
    if (needs_recovery()) { // has missing objects for any shard
	...
	search_for_missing(
      ...
      if (have_unfound()) // have unfound object
        // iterate each shard in PG::might_have_unfound to prepare MOSDPGQuery
...
// replica has less pg log than the primary
