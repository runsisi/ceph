...
// librbd::Operations<I>::execute_rename for format 1
template <typename I>
void ImageWatcher<I>::register_watch(Context *on_finish) {
  ...
  // m_watch_ctx will notify by calling ImageWatcher<I>::handle_notify, ImageWatcher<I>::handle_error
